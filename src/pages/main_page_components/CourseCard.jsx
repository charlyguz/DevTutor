  ...
  return (
    <div className="course-card p-4 m-4 text-white rounded-lg font-sans text-justify flex flex-col w-80 h-full bg-slate-800">
      ...
      <div className="flex justify-center mt-auto">
        <Link to={`/curso/${courseSlug}`} className="bg-black rounded-md p-2 inline-flex items-center justify-center text-white hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          {buttonText}
        </Link>
      </div>
    </div>
