...
export default function PythonTemario() {
    ...
    const niveles = [
        { 
            ...
            temas: [
                {
                    nombre: 'Introducción a Algoritmos y Estructura de Datos', 
                    subtemas: ['Definición y conceptos básicos', 'Importancia y aplicaciones', 'Complejidad algorítmica', 'Herramientas y recursos']
                }, 
                {
                    nombre: 'Estructuras de Datos Fundamentales',
                    subtemas: ['Arrays', 'Listas enlazadas', 'Pilas y colas', 'Árboles']
                },
                {
                    nombre: 'Algoritmos de Ordenamiento y Búsqueda',
                    subtemas: ['Algoritmos de ordenamiento', 'Algoritmos de búsqueda', 'Análisis comparativo de algoritmos de ordenamiento y búsqueda']
                },
                {
                    nombre: 'Estructuras de Datos Avanzadas',
                    subtemas: ['Grafos', 'Árboles de búsqueda balanceados', 'Colas de prioridad', 'Tablas hash']
                },
                {
                    nombre: 'Optimización de Algoritmos',
                    subtemas: ['Técnicas de optimización', 'Análisis de algoritmos recursivos y iterativos', 'Optimización de algoritmos de búsqueda y ordenamiento']
                },
            ], 
            desbloqueado: true 
        },
        { 
            nivel: 'Intermedio', //Actualizar el temario con Algoritmos en lugar de Python en intermedio y avanzado
            temas: [
                {
